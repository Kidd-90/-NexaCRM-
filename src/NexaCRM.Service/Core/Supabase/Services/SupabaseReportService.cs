...
using NexaCRM.Service.Analytics;
...
public sealed class SupabaseReportService : IReportService
{
    ...
    private async System.Threading.Tasks.Task<ReportData> GetCachedReportAsync(
        string format,
        string retentionKey,
        Func<global::Supabase.Client, AnalyticsSourceData, System.Threading.Tasks.Task<ReportData>> generator)
    {
        try
        {
            var client = await _clientProvider.GetClientAsync();
    ...
    private async System.Threading.Tasks.Task<AnalyticsSourceData> LoadAnalyticsSourceDataAsync(global::Supabase.Client client)
    {
    ...
    private async System.Threading.Tasks.Task PruneSnapshotsAsync(global::Supabase.Client client, Guid userId)
    {
    ...
    private static Guid EnsureUserId(global::Supabase.Client client)
    {
