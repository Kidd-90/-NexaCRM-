...
public sealed class SupabaseStatisticsService : IStatisticsService
{
    ...
    private async Task<int> LoadTotalMembersAsync(global::Supabase.Client client)
    {
    ...
    private async Task PruneStatisticsAsync(global::Supabase.Client client, DateTime referenceDate)
    {
