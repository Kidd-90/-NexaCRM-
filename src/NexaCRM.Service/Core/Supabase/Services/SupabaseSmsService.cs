...
public sealed class SupabaseSmsService : ISmsService
{
    ...
    private async Task<SmsSettings?> LoadSettingsAsync(global::Supabase.Client client, Guid userId)
    {
    ...
    private async Task CreateAuditLogAsync(global::Supabase.Client client, Guid userId, string action, string payload)
    {
        try
        {
    ...
    private async Task CreateIntegrationEventAsync(global::Supabase.Client client, string eventType, object payload)
    {
        try
        {
